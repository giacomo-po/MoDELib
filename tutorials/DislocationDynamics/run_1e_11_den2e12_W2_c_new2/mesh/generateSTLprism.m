...
b=0.2722e-9;
L1=0.5e-6/b; % the side length of the cube, in units of Burgers vector
L2=0.5e-6/b; % the side length of the cube, in units of Burgers vector
L3=1.5e-6/b; % the side length of the cube, in units of Burgers vector
