...
L1=1000; % the side length of the cube, in units of Burgers vector
L2=1000; % the side length of the cube, in units of Burgers vector
L3=1000; % the side length of the cube, in units of Burgers vector
