...
L1=500; % the side length of the cube, in units of Burgers vector
L2=500; % the side length of the cube, in units of Burgers vector
L3=500; % the side length of the cube, in units of Burgers vector
