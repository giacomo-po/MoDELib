...
//    
//    // ele;
//    std::cout<<LagrangeElement<2,1>::baryNodalCoordinates<<std::endl;
//    std::cout<<bary.transpose()<<std::endl;
//
//    std::cout<<LagrangeElement<2,1>::sf(bary)<<std::endl;
    ...
    typedef DiscontinuousLagrangeElement<dim,2> ElementType;
//    typedef LagrangeElement<dim,1> ElementType;
    ...
    auto dV=fe.domain<EntireDomain,37,GaussLegendre>();
...
//    rho += rhoDot*dt;
    ...
    /**************************************************************************/
    // Output function on external mesh faces
    SequentialOutputFile<'D',1> uFile;
    uFile<<rhoDot.domainView();
//    
//    
