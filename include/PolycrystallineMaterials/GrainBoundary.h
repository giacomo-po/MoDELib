...
//
//            std::cout<<"   GB plane normal for grain "<< grain.grainID<<":"<<defaultColor<<std::endl;
//            std::cout<<"      cartesian components="<<R.cartesian().normalized().transpose()<<defaultColor<<std::endl;
//            std::cout<<"      crystallographic components="<<grain.rationalApproximation((grain.C2G.transpose()*R.cartesian())).transpose()<<defaultColor<<std::endl;
////            std::cout<<"   crystallographic components="<<(grain.C2G.transpose()*R.cartesian()).transpose()<<defaultColor<<std::endl;
//            std::cout<<"      interplanar spacing="<<1.0/R.cartesian().norm()<<defaultColor<<std::endl;
//
...
//            {
//                std::cout<<"TILT BOUNDARY"<<std::endl;
...
//            {
//                std::cout<<"TWIST BOUNDARY"<<std::endl;
//
//            }
//            else
//            {
//                std::cout<<"MIXED BOUNDARY"<<std::endl;
//
//            }
//
//
...
//                                     const SimplicialMesh<dim>& mesh)
//        {
////            std::cout<<yellowColor<<"GrainBoundary ("<<grainBndID.first<<" "<<grainBndID.second<<")"<<defaultColor<<std::endl;
////            _csl.update(true);
////            _dscl.update(true);
//            computeCrystallographicRotationAxis();
