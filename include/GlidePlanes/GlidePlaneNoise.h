...
//    typedef double _Complex COMPLEX;
    ...
    typedef Eigen::Matrix<int,3,1> GridType;
    typedef Eigen::Matrix<REAL_SCALAR,2,1> NoiseType;
...
struct SolidSolutionNoiseReader
{
    ...
    static GridType Read_dimensions(const char *fname)
    {
        int NX, NY, NZ;
        char line[200];
        double temp;
        ...
        return (GridType()<<NX,NY,NZ).finished();
    }
