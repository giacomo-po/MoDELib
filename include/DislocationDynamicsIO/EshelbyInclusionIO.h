...
#ifndef model_EshelbyInclusionIO_H_
#define model_EshelbyInclusionIO_H_
...
namespace model
{
    ...
    struct EshelbyInclusionIO
    {
        ...
        EshelbyInclusionIO(const EshelbyInclusionType& ei) :
        ...
        EshelbyInclusionIO(const size_t& inclusionID_in,
        ...
        EshelbyInclusionIO(std::stringstream& ss) :
        /* init */ inclusionID(0)
        /* init */,C(VectorDim::Zero())
        /* init */,a(0)
        /* init */,eT(MatrixDim::Zero())
        ...
        template <class T>
        friend T& operator << (T& os, const EshelbyInclusionIO<dim>& ei)
        {
            os  << ei.inclusionID<<"\t"
