...
//                /* init list */,sectorID(0)
        ...
        void init(DislocationNetworkType& DN)
        {
            ...
            std::cout<<greenColor<<"Initializing ClockIndentationController at runID="<<runID<<defaultColor<<std::endl;
...
//                assert(indentationStepsPerSector>=relaxSteps);
                ...
                {
                    std::cout<<"ClockIndentationControllerController: F/F_0.txt cannot be opened. Inititializing from initial loading."<<std::endl;
                }
            }
