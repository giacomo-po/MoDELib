...
//        static constexpr int voigtSize=dim*(dim+1)/2;
    ...
    public:
        ...
        void init(DislocationNetworkType& DN)
        {
            ...
            std::cout<<greenColor<<"Initializing SequentialTorsionTensionController at runID="<<runID<<defaultColor<<std::endl;
...
//                EDR.readScalarInFile(inputFileName,"tau",tau);
                ...
                {
                    std::cout<<"SequentialTorsionTensionControllerController: F/F_0.txt cannot be opened. Inititializing from initial loading."<<std::endl;
                }
            }
