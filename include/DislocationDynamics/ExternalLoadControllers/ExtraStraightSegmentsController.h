...
//        /* init list */ sample_volume(1.0),
        ...
        void init(const DislocationNetworkType& DN)
        {
            ...
            std::cout<<greenColor<<"Initializing External Stress Field Controller at runID="<<runID<<defaultColor<<std::endl;
...
//            EDR.readMatrixInFile(inputFileName,"P0",P0);
            ...
            if (DN.use_extraStraightSegments)
            {
                ...
                {
                    std::cout<<"could not read runID from B/B_0.txt"<<std::endl;
                }
            }
