...
//                        {
//                            std::cout<<"PlanarDislocationNode "<<this->sID<<std::endl;
//                            std::cout<<"glidePlane(0) is "<<*glidePlanes().begin()->P.transpose()<<","<<*glidePlanes().begin()->unitNormal.transpose()<<std::endl;
//                            std::cout<<"glidePlane(1) is "<<*glidePlanes().rbegin()->P.transpose()<<","<<*glidePlanes().rbegin()->unitNormal.transpose()<<std::endl;
...
//                            default:
//                            {
//                                std::cout<<"PlanarDislocationNode "<<this->sID<<" boundingBoxSegments() are:"<<std::endl;
//                                std::cout<<this->boundingBoxSegments();
...
//                            }
//                            std::cout<<"MeshPlane intersection is:"<<std::endl;
//                            std::cout<<std::setprecision(15)<<std::scientific<<"  P0="<<_glidePlaneIntersections->P0.transpose()<<", P2="<<_glidePlaneIntersections->P1.transpose()<<std::endl;
//
//                            assert(0 && "Intersection must be COINCIDENT or INCIDENT.");
//                            break;
//                        }
