...
namespace model
{
    struct LatticePlane
    {
        ...
        static std::pair<ReciprocalLatticeDirection<dim>,size_t> correct_h_sign(const long int& h,const ReciprocalLatticeDirection<dim>& r)
        {
                                                                        ...
                                                                        const VectorDimD& P)
        {
            ...
            if(fabs(hd-h)>FLT_EPSILON)
            {
                ...
                std::cout<<"r="<<r.cartesian().transpose()<<std::endl;
