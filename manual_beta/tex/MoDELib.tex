...
\begin{figure}[h]
 ...
 \includegraphics[width=\textwidth]{cylindricalPunchTutorial_1}
 \caption{Add a box}
  \label{cylindricalPunchTutorial1}
\end{subfigure}
  \begin{subfigure}{\textwidth}
 \includegraphics[width=\textwidth]{cylindricalPunchTutorial_2}
...
\end{subfigure}
 ...
 \centering
  \begin{subfigure}{\textwidth}
 \includegraphics[width=\textwidth]{cylindricalPunchTutorial_3}
 \caption{Add a box}
  \label{cylindricalPunchTutorial1}
\end{subfigure}
  \begin{subfigure}{\textwidth}
 \includegraphics[width=\textwidth]{cylindricalPunchTutorial_4}
 \caption{Add a box}
  \label{cylindricalPunchTutorial2}
\end{subfigure}
   \caption{Geometry definition }
 ...
 \centering
  \begin{subfigure}{\textwidth}
 \includegraphics[width=\textwidth]{cylindricalPunchTutorial_5}
 \caption{Add a box}
  \label{cylindricalPunchTutorial1}
\end{subfigure}
   \caption{Geometry definition }
