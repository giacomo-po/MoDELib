...
namespace model
{
    ...
    struct DislocationMobilityHEXpyramidal : DislocationMobilityBase
    {
        ...
        /**********************************************************************/
        DislocationMobilityHEXpyramidal(const MaterialBase& material) :
        /* init */ DislocationMobilityBase("HEX-pyramidal DislocationMobility for "+material.materialName),
