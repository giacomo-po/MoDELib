...
//    };
    ...
    class SuperPlanePatch : private std::vector<std::shared_ptr<SuperPlaneNode<SuperLoopType>>>
    {
        ...
        typedef Vector2d PatchPointType;
        typedef std::vector<PatchPointType,Eigen::aligned_allocator<PatchPointType> > PatchPointTypeContainerType;
...

    {
        ...
        typedef std::vector<sta::pair<Vector2d,const NodeType* const>,Eigen::aligned_allocator<Vector2d> > Vector2dContainer;
