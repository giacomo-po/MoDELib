...
//        {
//            typename LinkContainerType::iterator edgeIter(linkMap.find(std::make_pair(i,j)));
//            return (edgeIter==linkMap.end())?  std::make_pair(false,static_cast<LinkType* const>(nullptr)) :
//            /*                              */ std::make_pair(true,edgeIter->second);
//        }
