...
//        Eigen::Matrix<double,1,qOrder> AvoidMacOsXBug1=Quadrature<1,qOrder,QuadratureRule>::abscissas; // is this static initialization fiasco?
//        Eigen::Matrix<double,1,qOrder> AvoidMacOsXBug2=Quadrature<1,qOrder,QuadratureRule>::weights;   // is this static initialization fiasco?
