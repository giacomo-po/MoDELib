...
//        static_assert(false, "CrystalStructure must be FCC or BCC");
    ...
    struct DislocationMobility<FCC>
    {
        ...
        {
//            model::cout<<yellowColor<<"Creating DislocationMobility<FCC>"<<std::endl;
//            model::cout<<yellowColor<<"      B0="<<B0<<std::endl;
//            model::cout<<yellowColor<<"      B1="<<B1<<defaultColor<<std::endl;
        }
        
        template<typename ForceType>
        constexpr ForceType velocity(const ForceType& f, const double& T)
        {
            return f/(B0+B1*T);
        }
