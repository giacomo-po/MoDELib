...
namespace model {	
	...
	public:
        ...
        static MatrixDimD multipoleStress(const VectorDimD& Rfield, const MatrixDimD& alpha){
    ...
    template <int dim>
    struct Eigen::Matrix<double,dim,dim> MultipoleExpansion<dim>::I=Eigen::Matrix<double,dim,dim>::Identity();
