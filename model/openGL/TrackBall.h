...
#ifndef model_TRACKBALL_H_
#define model_TRACKBALL_H_
...
namespace model {
    ...
    class TrackBall{
        ...
        static float gRadiusTrackball;
        static float gStartPtTrackball[3];
        static float gEndPtTrackball[3];
        static long gXCenterTrackball;
        static long gYCenterTrackball;
        
    public:
        
        // mouse positon and view size as inputs
        static void start(long x, long y, long originX, long originY, long width, long height)
        {
            float xxyy;
            float nx, ny;
        ...
        static void rollToTrackball (long x, long y, float rot [4]) // rot is output rotation angle
        {
            float xxyy;
            float cosAng, sinAng;
            float ls, le, lr;
        ...
        static void addToRotation (float * dA, float * A)
        {
    ...
    //static data
    const float TrackBall::kTol = 0.001;
    const float TrackBall::kRad2Deg = 180. / 3.1415927;
    const float TrackBall::kDeg2Rad = 3.1415927 / 180.;
    float TrackBall::gRadiusTrackball;
    float TrackBall::gStartPtTrackball[3];
    float TrackBall::gEndPtTrackball[3];
    long TrackBall::gXCenterTrackball = 0;
    long TrackBall::gYCenterTrackball = 0;
