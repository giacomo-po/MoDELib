...
namespace model {
	...
	struct SchurComplementSparseSolver  {
		 ...
		 SparseMatrixType KPQT;

		 Eigen::SimplicialLLT <SparseMatrixType> llt;
//        const SparseMatrixType temp1;

//		 Eigen::SimplicialLDLT<SparseMatrixType> ldlt;
...
//		/*                                                                   */ llt(KQQ), 
//		/*                                                                   */ ldlt(KPQ*llt.solve(KPQT)), 
//		/*                                                                   */ L(ldlt.solve(KPQ*llt.solve(Fq)-Fp)),
...
//        SchurComplementSparseSolver(const SparseMatrixType& KQQ, const SparseMatrixType& KPQ, 
//        /*          */ const Eigen::VectorXd& Fq) : KPQT(KPQ.transpose()),
//		/*                                       */ llt(KQQ), 
//        lltSOL(llt.solve(KPQT)),
//		/*                                       */ ldlt(lltSOL), 
//		/*                                       */ L(ldlt.solve(KPQ*llt.solve(Fq))),
//		/*                                       */ X(llt.solve(Fq-KPQT*L)){
////        /*                                       */ X(Eigen::Matrix<double,3,3>::Zero()){
//
//            checkSolution();
//		}
        
        
        SchurComplementSparseSolver(const SparseMatrixType& KQQ, const Eigen::MatrixXd& KPQ, 
