...
//                        temp.first=false;
        ...
        /* init */ P(intersectionType==coincidentLines? l1.P : (intersectionType==intersectingLines? l1.P-dPxd2.gCD/d1xd2.gCD*(1-2*((dPxd2+d1xd2).squaredNorm()==0))*l1.d : LatticeVectorType(l1.P.covBasis,l1.P.contraBasis)))
        {
