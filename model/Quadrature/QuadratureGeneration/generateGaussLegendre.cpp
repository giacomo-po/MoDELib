...
int main(int argc, char *argv[]){
    ...
    std::string includeFileName("../GaussLegendre/includeGaussLegendre1D.h");
    ...
    for (int p=0; p<=quadraturePowerMax;++p){
        ...
        filestream << "../GaussLegendre/dim1/GaussLegendre_1_" << qOrder << ".h";
        std::string filename=filestream.str();
        std::cout<<" done. Writing file "<<filestream.str()<<std::endl;
