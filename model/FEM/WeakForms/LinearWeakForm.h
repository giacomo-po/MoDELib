...
//        static_assert(DerivedEval::cols==1,"DerivedEval MUST HAVE EXACTLY ONE COLUMN");
        ...
        typedef typename DerivedTest::TrialFunctionType TF;
        typedef LinearWeakForm<DerivedTest,DerivedEval> LinearWeakFormType;
        typedef typename TypeTraits<TF>::ElementType ElementType;
        
        constexpr static int dim=TypeTraits<TF>::dim;
        constexpr static int dofPerNode=TypeTraits<TF>::dofPerNode;
        constexpr static int dofPerElement=TypeTraits<TF>::dofPerElement;
    ...
    public:
        ...
        Eigen::Matrix<double,Eigen::Dynamic,1> globalVector; // this should be private
...
//        }
        ...
        void assembleOnBoundary(const IntegrationDomain<dim,1,qOrder,QuadratureRule>& bnd)
        {
            ...
            typedef Quadrature<TF::dim-1,qOrder,QuadratureRule> QuadratureType;
            typedef typename QuadratureType::VectorDim AbscissaType;
