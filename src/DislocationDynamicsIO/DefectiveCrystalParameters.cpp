...
//                    const auto iter=vReader.find(runID);
        ...
        /* init */,periodicImages_x(simulationType==PERIODIC_IMAGES? TextFileParser(traitsIO.ddFile).readScalar<int>("periodicImages_x",true) : 0)
        /* init */,periodicImages_y(simulationType==PERIODIC_IMAGES? TextFileParser(traitsIO.ddFile).readScalar<int>("periodicImages_y",true) : 0)
        /* init */,periodicImages_z(simulationType==PERIODIC_IMAGES? TextFileParser(traitsIO.ddFile).readScalar<int>("periodicImages_z",true) : 0)
