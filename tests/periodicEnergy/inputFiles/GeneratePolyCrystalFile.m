...
T=round(1000*diag(1./Ln))

%T=[1000 0 0
%    0 1000 0
%    0 0 1000]; % integer combination

B=L*T; % box

x0=[0 0 0];
fID=fopen('polycrystal.txt','w');
fprintf(fID,['materialFile=../../../tutorials/DislocationDynamics/MaterialsLibrary/' material '.txt; \n']);
fprintf(fID,'enablePartials=0; \n');
fprintf(fID,'absoluteTemperature = 300; # [K] simulation temperature \n');
fprintf(fID,'meshFile=../../../tutorials/DislocationDynamics/MeshLibrary/unitCube.msh; \n');
fprintf(fID,'C2G1=');
