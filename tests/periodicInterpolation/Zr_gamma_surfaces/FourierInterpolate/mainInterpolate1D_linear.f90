PROGRAM Interpolation1D_linear
        ...
        REAL(kind(0.d0)) :: x0, x1, x, fx, dfdx, d2fdx2, f1
        ...
        READ(5,*) nCol
        WRITE(6,'(a)') 'Pente de la contribution linéaire à retrancher'
        READ(5,*) f1
        OPEN(file=inpFile, unit=50, status='old', action='read')
        CALL ReadGridFile1D_linear(50, nxCol, nCol, nVal, T, f1, f)
        CLOSE(50)
        ...
        WRITE(61,'(a,g20.12)') '# Pente de la contribution linéaire à retrancher', f1
        WRITE(61,'(a)') '#'
        !Write(61,'(a,g20.12)') '# Constante à retrancher de la fonction: ', 0.d0
        !WRITE(61,'(a,g20.12)') '# Facteur multiplicatif: ', 1.d0
        WRITE(61,'(a)')        '#'
        ...
        WRITE(62,'(a,g20.12)') '# Pente de la contribution linéaire à retrancher', f1
        WRITE(62,'(a)') '#'
        ...
        DO n=0, n0
           ...
           WRITE(62,'(4g24.12)') x, fx+f1*x, dfdx+f1, d2fdx2
        END DO
        CLOSE(62)

        Deallocate(f) ; Deallocate(cf) ; Deallocate(sf)

END PROGRAM Interpolation1D_linear
