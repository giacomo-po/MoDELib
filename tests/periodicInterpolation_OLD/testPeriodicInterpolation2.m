...
df=[0 0 1 0 0;              % Al
    0 0 1 sqrt(3) 0;              % Al
   0.5 sqrt(3)/6 -1 sqrt(3) 0; % Ni
   0.5 sqrt(3)/2  1 sqrt(3) 0; % Ni
   1 sqrt(3)/3 1 0 0; % Al
   1 sqrt(3)/3 1 sqrt(3) 0; % Al
   1 2*sqrt(3)/3 1 0 0 % Ni
   1.5 sqrt(3)/2 -1 sqrt(3) 0; % Ni
   2 2*sqrt(3)/3 1 0 0; % Al
   2 2*sqrt(3)/3 1 sqrt(3) 0; % Al
   2.5 5*sqrt(3)/6 -1 sqrt(3) 0; %Ni
 %  1 0 1 0 0;
 %  1.5 5*sqrt(3)/6 1 sqrt(3) 0;
    ];
...
np=400;
[X,Y] = meshgrid([0:2/(np-1):4],[0:sqrt(3)*2/(np-1):sqrt(3)*2]);
f=zeros(size(X));
for i=1:size(data,1)
    k=data(i,[1 2]);
    S=data(i,3);
